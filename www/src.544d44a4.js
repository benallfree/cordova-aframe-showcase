...
const Home = () => {
  return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Home"), _react.default.createElement("nav", null, _react.default.createElement("ul", null, _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/hello-webvr"
  }, "Hello WebVR")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/hello-metaverse"
  }, "Hello Metaverse")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/gallery"
  }, "Gallery")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/360image"
  }, "360 Image")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/dynamic-lights"
  }, "Dynamic Lights")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/anime-ui"
  }, "Anime UI")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/animation"
  }, "Animation")))));
};
...
const HelloWebVR = React.lazy(() => require("_bundle_loader")(require.resolve('./demos/HelloWebVR')));
const HelloMetaverse = React.lazy(() => require("_bundle_loader")(require.resolve('./demos/HelloMetaverse')));
const Gallery = React.lazy(() => require("_bundle_loader")(require.resolve('./demos/Gallery')));
const Image360 = React.lazy(() => require("_bundle_loader")(require.resolve('./demos/Image360')));
const DynamicLights = React.lazy(() => require("_bundle_loader")(require.resolve('./demos/DynamicLights')));
const AnimeUI = React.lazy(() => require("_bundle_loader")(require.resolve('./demos/AnimeUI')));
...
const Root = () => {
  return React.createElement(React.Suspense, {
    ...
    path: "/hello-webvr"
  }, React.createElement(HelloWebVR, null)), React.createElement(_reactRouterDom.Route, {
    path: "/hello-metaverse"
  }, React.createElement(HelloMetaverse, null)), React.createElement(_reactRouterDom.Route, {
    path: "/gallery"
  }, React.createElement(Gallery, null)), React.createElement(_reactRouterDom.Route, {
    path: "/360image"
  }, React.createElement(Image360, null)), React.createElement(_reactRouterDom.Route, {
    path: "/dynamic-lights"
  }, React.createElement(DynamicLights, null)), React.createElement(_reactRouterDom.Route, {
    path: "/anime-ui"
  }, React.createElement(AnimeUI, null)), React.createElement(_reactRouterDom.Route, {
    path: "/"
  }, React.createElement(_Home.Home, null)))));
};

exports.Root = Root;
},{"react":"n8MK","react-router-dom":"uc19","./Home":"l3PF","_bundle_loader":"TUK3","./demos/HelloWebVR":[["HelloWebVR.ec00bb11.js","dWfe"],"HelloWebVR.ec00bb11.js.map","dWfe"],"./demos/HelloMetaverse":[["HelloMetaverse.63403d74.js","YaiC"],"HelloMetaverse.63403d74.js.map",["1hyyIUi.08811720.jpg","zfz5"],["25P1geh.8e0d0756.png","Dowq"],["WMNH2OF.9ebc5547.jpg","YybL"],["WqlqEkq.55da4df1.jpg","LfN8"],["dawningOfANewDayRegular.typeface.587ed2ce.json","gdHI"],["exo2Black.typeface.addb2fbf.json","waO3"],["exo2BlackItalic.typeface.f1641af0.json","XxLo"],"YaiC"],"./demos/Gallery":[["Gallery.b1c106a0.js","PJSA"],"Gallery.b1c106a0.js.map",["carpet.78026e68.jpg","jh2Q"],["marble.5dbaf5fa.jpg","jSxj"],"PJSA"],"./demos/Image360":[["Image360.4c9a6bf2.js","TS3R"],"Image360.4c9a6bf2.js.map",["puydesancy.e68625a0.jpg","N87Z"],"TS3R"],"./demos/DynamicLights":[["DynamicLights.b65b5493.js","D6vY"],"DynamicLights.b65b5493.js.map","D6vY"],"./demos/AnimeUI":[["AnimeUI.11a9a9db.js","NHWw"],"AnimeUI.11a9a9db.js.map",["321103__nsstudios__blip1.167c5cc6.wav","aE9A"],["321104__nsstudios__blip2.c5122dc0.wav","pEdp"],["glow1.c4e638c6.png","F7Ji"],["ring1.b08eaab0.png","GH7H"],["ring2.278b8d4e.png","ku9P"],["ring3.ec580d2c.png","dw3C"],["ring4.85dad3af.png","uf0j"],["ring5.dfd84fc7.png","cFRU"],["schematic1.a2462577.png","nu9u"],["schematic2.9686e735.png","BMq1"],["schematic3.f91b7947.png","LvPB"],["schematic4.f9fbf1c0.png","jr9F"],["schematic5.7c316ff3.png","h8jI"],["text1.57d0d1a8.png","QTPp"],["text2.ff5d4f94.png","kWxA"],["text3.a5935bc2.png","t1k5"],["text4.d423b84f.png","NkHM"],["engine.37fef59a.glb","PrEc"],"NHWw"]}],"zo2T":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=src.544d44a4.js.map